    ...
    <section id="docs" class="docs section">
        ...
        <!-- Aplicadas en las filas -->
                ...
                <table class="table text-center">
                    ...
                    <thead>
                        <tr>
                            <td colspan="6"><h3>Proveedores</h3></td>
                        </tr>
                        <tr class="info">
                            <th class="col-md-2 text-center"><strong>RUT</strong></th>
                            <th class="col-md-2 text-center"><strong>Nombre Fantasía</strong></th>
                        </tr>
        ...
        <!-- Aplicadas en las filas -->
                        <tr class="active">
                            <td>5608813-K</td>
                            <td>CENTRO DE EVENTOS "LA ESPIGA"</td>
                        </tr>
                        <tr class="active">
                            <td>9563422-2</td>
                            <td>P M Y S</td>
                        ...
                        <tr class="active">
                            <td>76100732-7</td>
                            <td>DISTRIBUCION GLOBAL LTDA</td>
                        </tr>
                        <tr class="active">
                            <td>22739656-3</td>
                            <td>ODONTOLOGO</td>
